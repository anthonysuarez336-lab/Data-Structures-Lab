...
do
{
    ...
    var stratum = ConsoleExtension.GetDecimal("Estrato del estudiante..........: ");
...
decimal CalculateSubsidy(decimal stratum)
{
    if (stratum == 1)
    { 
        return 200000m;
...
decimal CalculateRegistrationValue(int credits, decimal creditValue, decimal stratum)
{
    decimal value;
    if (credits <= 20)
    {
